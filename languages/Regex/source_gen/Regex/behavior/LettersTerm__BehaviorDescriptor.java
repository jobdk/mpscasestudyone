...
public final class LettersTerm__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x57f03870b8ad4e95L, 0xbd9bd3ba356b36eeL, 0x1a5c698304eb2de9L, "Regex.structure.LettersTerm");
  ...
  /*package*/ static String getRegexTerm_id1Dsqoc50bGB(@NotNull SNode __thisNode__) {
    return "[a-zA-ZäÄüÜöÖß\\s]+";
  }

  /*package*/ LettersTerm__BehaviorDescriptor() {
  }
